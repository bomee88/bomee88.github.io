...
css preprocessor인 **S**yntactically **A**wesome **S**tyle**S**heets 의 약자인 Sass는 [Sass 가이드라인](htts://sass-guideline.es/ko)을 참고하면 좋다.  
sass를 사용하면 두가지 확장자를 사용할 수 있는데 sass와 scss이다.
